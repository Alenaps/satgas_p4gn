...
class ProfileController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        if ($user->role === 'konselor') {
            ...
            $rules['id_instansi']         = ['nullable', Rule::exists(Instansi::class, 'id')]; // FIX: pakai Rule::exists agar ikut $table di model
            $rules['id_jabatan']          = ['nullable', Rule::exists(Jabatan::class, 'id')];  // FIX: sama seperti di atas
