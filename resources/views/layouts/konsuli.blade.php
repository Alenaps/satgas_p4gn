    ...
    <nav class="bg-gradient-to-r from-green-500 to-green-600 shadow-lg" x-data="{ open: false }">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <!-- Navigation Menu (Desktop) -->
                <ul class="hidden lg:flex items-center gap-6 text-sm font-medium">
                    ...
                    <li><a href="{{ route('profile.index') }}" class="text-white hover:bg-white/15 px-4 py-2 rounded {{ Request::routeIs('profile.*') ? 'bg-white/20' : '' }}">PROFILE</a></li>
                    <li><a href="{{ route('logout') }}" class="text-white hover:bg-white/15 px-4 py-2 rounded {{ Request::routeIs('logout') ? 'bg-white/20' : '' }}">LOGOUT</a></li>
                </ul>
        </div>
        ...
        <div x-show="open" x-transition class="lg:hidden bg-green-600/90 backdrop-blur-md">
            <ul class="flex flex-col items-center py-4 space-y-2">
                ...
                <li><a href="{{ route('profile.index') }}" class="text-white hover:bg-white/15 px-4 py-2 rounded block">PROFILE</a></li>
                <li><a href="{{ route('logout') }}" class="text-white hover:bg-white/15 px-4 py-2 rounded block">LOGOUT</a></li>
            </ul>
        </div>
    </nav>
