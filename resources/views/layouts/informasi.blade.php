...
<footer class="bg-green-800 text-green-300 border-t border-green-700">
        <div class="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-2 flex flex-col ">
                ...
                <p class="text-sm mt-2 opacity-70">Email: satgasp4gn@kpa.unila.ac.id</p>
                <p class="text-sm opacity-70">Alamat: Ruang UPA Bimbingan Konseling, Lantai 3 Gedung Rektorat Universitas Lampung</p>

                <div class="flex gap-4 mt-4">
                    <!-- Social Icons -->
                    <a href="https://www.instagram.com/satgas.p4gn/" class="text-green-300 hover:text-white" aria-label="Instagram">
