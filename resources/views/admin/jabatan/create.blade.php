...
<div class="max-w-5xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Tambah Jabatan</h2>
            <p class="text-sm text-gray-500 mt-0.5">Isi form berikut untuk menambahkan jabatan baru</p>
        </div>
    </div>

    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-lg">
        <form id="form-jabatan-create" action="{{ route('admin.jabatan.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-6">
                ...
                <input type="text" id="nama_jabatan" name="nama_jabatan" value="{{ old('nama_jabatan') }}" placeholder="Contoh: Konselor Utama" autocomplete="off"
...
const FORM_ID             = 'form-jabatan-create';
</script>
